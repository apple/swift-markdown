...
public struct MarkupFormatter: MarkupWalker {
    ...
    public mutating func visitCustomAttributes(_ attributes: CustomAttributes) {
        let savedState = state
        func printCustomAttributes() {
        ...
        // Custom attributes *can* have their key-value pairs split across multiple
